...
class MAPPO2:
    ...
    def learn(self, total_timesteps, callback=None, eval_callback = None, log_interval=1, tb_log_name="PPO2",
              reset_num_timesteps=True, save_dir = 'MAPPO2', save_interval=20, save_path=[]):
        ...
        for update in range(1, n_updates + 1):
            ...
            lr_now_s = [None, None, None]
            cliprange_now_s = [None, None, None]
            cliprange_vf_now_s = [None, None, None]
            for i in range(self.n_agents):
    ...
    def run(self, eval_callback):
        ...
        for _ in range(self.n_steps):
            ...
            if eval_callback.check():
                ...
                print("Evaluation has started")  # 之前的代码大概24update evaluate一次...
            ...
            self.dones = [self.dones for _ in range(3)]
